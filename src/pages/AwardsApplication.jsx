...
const scholarshipData = [
  {
    ...
    criteria:
      "Exceptional academic achievement (GPA 3.9+), leadership, and community service.",
  ...
  },
  {
    ...
    criteria:
      "Outstanding talent in visual or performing arts, portfolio submission required.",
...
const applicationSteps = [
  {
    ...
    description:
      "Carefully read the criteria for each award to ensure you qualify.",
  },
  {
    icon: CheckSquare,
    title: "Prepare Documents",
    description:
      "Gather transcripts, recommendation letters, essays, and portfolios as required.",
  },
  {
    icon: Calendar,
    title: "Note Deadlines",
    description:
      "Submit your application and all supporting materials by the specified deadline.",
  },
  {
    icon: Users,
    title: "Seek Recommendations",
    description:
      "Request letters of recommendation well in advance from teachers or mentors.",
  },
];
...
const AwardsApplication = () => {
  const handleApplyClick = (awardTitle) => {
    toast({
      ...
      description:
        "The application portal for this award isn't implemented yet. Please check back later or contact the financial aid office. 🚀",
    });
  };
  ...
  const handleGeneralApplyClick = () => {
    toast({
      ...
      description:
        "The general scholarship application portal isn't implemented yet. 🚀",
    });
  };

  const url =
    "https://images.unsplash.com/photo-1551845728-6820a30c64e2?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";

  return (
    <div className="min-h-screen bg-gray-50">
      <section
        className="pt-60 pb-40 hero-gradient bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage:
            'url("https://images.unsplash.com/photo-1551845728-6820a30c64e2?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D")',
          ...
          >
            ...
            <div className="flex items-start gap-4">
              ...
              <p className="text-xl text-blue-100 leading-relaxed">
                Discover various scholarship and award opportunities available
                to support your academic journey at Abraham University.
              </p>
            </div>
          </motion.div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We offer a range of scholarships based on merit, need, and
              specific talents. Explore the options below.
            </p>
          </motion.div>
            ...
            {scholarshipData.map((scholarship, index) => (
              ...
              >
                <div className="h-56 relative overflow-hidden">
                  <img-replace
                    src={`https://source.unsplash.com/random/600x400/?${scholarship.imageQuery}`}
                ...
                <div className="p-6 flex flex-col flex-grow">
                  <p className="text-gray-700 mb-2">
                    <strong className="font-medium">Criteria:</strong>{" "}
                    {scholarship.criteria}
                  </p>
                  <p className="text-sm text-red-600 font-medium mb-4">
                    <Calendar className="inline h-4 w-4 mr-1" /> Deadline:{" "}
      ...
      <section className="section-padding bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Follow these steps to successfully apply for scholarships and
              awards.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 leading-relaxed">
              Our Financial Aid office is here to help you navigate the awards
              and application process. Don't hesitate to reach out with your
              questions.
            </p>
            <Button
              asChild
